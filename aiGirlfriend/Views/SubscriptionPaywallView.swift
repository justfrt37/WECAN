...
//  Abonelik paywall'u — Pro/Pro+/Max tier'ları + tek seferlik token paketleri.
//  "Upgrade" / "Go PRO" gibi her yerden `PaywallHostView` ile açılır. Coin
//  Mağazası'ndaki (TokenStoreView) "Pro" butonu da bunu açar.
//  (Eski adı TokenStoreView idi; coin Mağazası ayrı bir ekrana taşınınca
//  abonelik içeriği buraya alındı.)
//
